...
jQuery.beautyOfCode={settings:{autoLoad:true,baseUrl:'http://alexgorbatchev.com/pub/sh/2.1.364/',scripts:'scripts/',styles:'styles/',theme:'Default',brushes:['Xml','JScript','CSharp','Plain'],config:{},defaults:{},ready:function(){jQuery.beautyOfCode.beautifyAll();}},init:function(settings){settings=jQuery.extend({},jQuery.beautyOfCode.settings,settings);if(!settings.config.clipboardSwf)
